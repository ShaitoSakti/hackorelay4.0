...
export const About = () => {
  ...
  return (
<<<<<<< HEAD
    <section className="relative min-h-screen w-full bg-neutral-900 py-20 overflow-hidden">
...
<<<<<<< HEAD
            ...
            >
              ...
              >
                <GlowingEffect
                  ...
                  borderWidth={2}
                  className="absolute inset-0 rounded-xl -z-10 pointer-events-none"
                  gradient="from-red-400/60 via-yellow-500/40 to-green-500/30"
                />
            ...
            >
              <motion.div
                ...
                className={cn(
                  ...
                  "shadow-xl shadow-red-500/20 h-full"
                )}
              >
                <GlowingEffect
                  blur={80}
                  ...
                  borderWidth={2}
                  className="absolute inset-0 rounded-xl -z-10 pointer-events-none"
                  gradient="from-red-400/40 via-yellow-500/30 to-green-500/20"
                />
            ...
            >
              <motion.div
                ...
                className={cn(
                  ...
                  "shadow-xl shadow-green-500/20 h-full"
                )}
              >
                <GlowingEffect
                  blur={80}
                  ...
                  borderWidth={2}
                  className="absolute inset-0 rounded-xl -z-10 pointer-events-none"
                  gradient="from-green-400/40 via-blue-500/30 to-yellow-500/20"
                />
                <div className="relative z-10 space-y-4">
        ...
        >
          ...
          <motion.a
            href="/register"
            className="inline-block px-8 py-3 bg-red-500 hover:bg-red-600 text-white rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all border-2 border-yellow-400"
